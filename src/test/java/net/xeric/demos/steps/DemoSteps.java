...
public class DemoSteps {
    ...
    @When("^I place the number (-?\\d+)$")
    public void the_roman_numeral_inputed_and_clicked(int arg1) throws Throwable {
        demoPage.calculateNumerals(arg1);
       
    }

    @Then("^the numeral is (.+)$")
    public void the_roman_numeral_displays(String arg1) throws Throwable {
        assertEquals(arg1, demoPage.getNumerals());
    }
}
